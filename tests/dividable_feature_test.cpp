...
{
    using integer_t = strong_type::strong_type<int, "integer_t", strong_type::dividable>;
    integer_t two{ 2 };
    integer_t four{ 4 };
...
{
    using integer_t = strong_type::strong_type<int, "integer_t", strong_type::dividable, strong_type::dividable_by<int>>;
