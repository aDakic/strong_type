...
{
    using integer_t = strong_type::strong_type<int, "integer_t", strong_type::addable>;
...
{
    using integer_t = strong_type::strong_type<int, "integer_t", strong_type::addable, strong_type::addable_with<int>>;
