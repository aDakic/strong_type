...
{
    using integer_t = strong_type::strong_type<int, "integer_t", strong_type::multiplicable>;
    integer_t one{ 1 };
    integer_t two{ 2 };
...
{
    using integer_t =
        strong_type::strong_type<int, "integer_t", strong_type::multiplicable, strong_type::multiplicable_with<int>>;
